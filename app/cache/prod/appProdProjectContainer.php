...
class appProdProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => '', 'dbname' => 'db_prestashop', 'user' => 'root', 'password' => '', 'charset' => 'UTF8', 'driverOptions' => array(1002 => 'SET sql_mode=(SELECT REPLACE(@@sql_mode,\'ONLY_FULL_GROUP_BY\',\'\'))'), 'serverVersion' => 5.1), new \Doctrine\DBAL\Configuration(), $a, array('enum' => 'string'));
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_29e9d5c412d4f2951048b4189b5cab3c82324b3241b5dcab266975a94e13ff38');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('D7F8LwkiEFSSqLpoVWLADSqLzzMvPcM4EDurg8EqhKkqxmpnrNLqhL7x');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5aada3cedab557.70927237')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'secret' => 'D7F8LwkiEFSSqLpoVWLADSqLzzMvPcM4EDurg8EqhKkqxmpnrNLqhL7x',
            'ps_caching' => 'CacheMemcache',
            'ps_cache_enable' => false,
            'ps_creation_date' => '2018-03-18',
            'locale' => 'es-ES',
            'cookie_key' => 'b5WHSikFZNgEtv9gbCw0Gp9QO9XO8b14t4sp7myK7w7v4inwroxonTUw',
            'cookie_iv' => '5dopEA59',
            'new_cookie_key' => 'def0000093ab26faa5559687ed62d765b6402857aae7da639b83948562a81c5e714fc1baf6b373c37d8f8f596255a3c1115ab380dbb3047af33b82d38c3244169bc21b7a',
            ...
            'kernel.secret' => 'D7F8LwkiEFSSqLpoVWLADSqLzzMvPcM4EDurg8EqhKkqxmpnrNLqhL7x',
